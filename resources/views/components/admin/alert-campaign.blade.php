<div {{ $attributes->merge([
    ...
    <button type="button" class="ms-auto bg-blue-50 text-blue-500 rounded-lg p-1.5 hover:bg-blue-200 h-8 w-8 dark:bg-gray-800 dark:text-blue-400 dark:hover:bg-gray-700" data-dismiss-target="#alert-border-1" aria-label="Close">
